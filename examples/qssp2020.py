...
def main():
    ...
    require_library_settings(library, min_harmonic=2000, max_harmonic=8000,
                             sampling_interval=dt, time_window=window,
                             source_duration=64.0, max_slowness=0.3,
    ...
    report.update(sampling_interval_s=dt, time_window_s=window, distances_km=distances,
                  spec_time_window_s=4092.0, max_frequency_hz=0.0625, harmonic_bounds=[2000, 8000], source_duration_s=64.0)
