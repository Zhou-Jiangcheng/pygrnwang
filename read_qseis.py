...
def seek_qseis(
    ...
    if (before_p is not None) or shift or pad_zeros:
        first_p, first_s = cal_first_p_s(
            ...
            dist_in_km=degrees2kilometers(green_dist),
...
if __name__ == "__main__":
    ...
    path_green_lib_ = "/e/all_green_lib/qseis06_lib0/"
    seismograms_, green_dist_ = seek_qseis(
        path_green_lib=path_green_lib_,
        event_depth_in_km=18,
        az_in_deg=299,
        dist_in_km=degrees2kilometers(30),
        focal_mechanism=[1, 0, 0, 1, 0, 1],
        srate=2,
        zero_phase=False,
        rotate=False,
        time_reduction_slowness=8,
